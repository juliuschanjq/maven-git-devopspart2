    ...
    <div class="row">
        <div class="container">
            ...
            <table class="table">
                ...
                <!-- Pass in the list of users received via the Servlet response to a loop -->
                <tbody>
                    <c:forEach var="user" items="${listUsers}">
                        ...
                        <tr>
                            ...
                            <!-- For each user in the database, Edit/Delete buttons which invoke the edit/delete functions -->
                            <td>
